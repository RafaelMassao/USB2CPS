...
// Generic HID instance state. Left unpacked on purpose: these structs
// live in RAM so alignment padding is harmless, and unpacking avoids the
// -Waddress-of-packed-member warnings below.
typedef struct
{
  dinput_usage_t xLoc;
  dinput_usage_t yLoc;
